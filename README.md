...
```javascript
incrpcorr2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-pcorr2@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-pcorr2@v0.1.1-umd/browser.js"></script>
```
